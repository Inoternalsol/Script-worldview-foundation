...
export default function EditCampaignPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <div>
        <h1 className="font-heading text-2xl font-bold text-foreground">Edit Campaign</h1>
        <p className="mt-1 text-sm text-brand-muted">Modify the details of your fundraising campaign.</p>
      </div>
